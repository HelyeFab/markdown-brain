...
DOCS_DIR = os.environ.get('DOCS_PATH', '/path/to/your/docs')
INDEX_FILE = "INDEX.md"
...
def scan_documents():
    ...
    if not os.path.exists(DOCS_DIR):
        ...
        print("Please update DOCS_DIR in this script or set DOCS_PATH environment variable")
        return documents
...
def main():
    ...
    if not documents:
        print("⚠️  No documents found. Please check your DOCS_DIR setting.")
        return
